...
public class CameraControl{
	...
	private int previewWidth; //プレビュー横幅
	private int previewHeight; //プレビュー縦幅
	 ...
	 * バックカメラのIDを取得
	 * 
	 * @return フロントカメラのIDを返す。フロントカメラが存在しない場合はフロントカメラIDを返す。
	 ***************************/
	...
	/***************************
	 * プレビューサイズを決定し設定する（横幅640以上の最小プレビューサイズにする）
	 * 
	 * @param カメラパラメータ
	 ***************************/
